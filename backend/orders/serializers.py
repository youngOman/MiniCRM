...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'id', 'order_number', 'customer', 'customer_info', 'status', 'order_date',
...
class OrderCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'customer', 'status', 'subtotal', 'tax_amount', 'shipping_amount',
            'discount_amount', 'shipping_address', 'billing_address', 'notes', 'items'
        ]
