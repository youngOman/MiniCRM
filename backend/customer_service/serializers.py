...
class ServiceNoteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ServiceNote
        fields = [
            'id', 'content', 'note_type', 'is_visible_to_customer',
            'attachments', 'created_at', 'created_by', 'created_by_info'
        ]
...
class ServiceTicketListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'customer', 'customer_info', 'assigned_to', 'assigned_to_info',
            'created_by', 'created_by_info', 'created_at', 'updated_at',
            'notes_count', 'satisfaction_rating'
        ]
...
class ServiceTicketDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'priority', 'status', 'customer', 'customer_info', 
            'assigned_to', 'assigned_to_info', 'created_by', 'created_by_info',
            'created_at', 'updated_at', 'first_response_at', 'resolved_at', 
            'closed_at', 'tags', 'satisfaction_rating', 'satisfaction_comment',
            'notes', 'response_time_display', 'resolution_time_display'
        ]
        read_only_fields = [
            'ticket_number', 'created_at', 'updated_at', 'created_by'
        ]
...
class ServiceTicketCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'customer', 'assigned_to', 'tags', 'satisfaction_rating',
...
class KnowledgeBaseCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'children', 'articles_count'
        ]
...
class KnowledgeBaseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KnowledgeBase
        fields = [
            'id', 'title', 'summary', 'category', 'category_info',
            'content_type', 'tags', 'is_public', 'is_featured',
            'created_by', 'created_by_info', 'updated_at',
            'view_count', 'helpfulness_ratio'
        ]
...
class KnowledgeBaseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KnowledgeBase
        fields = [
            'id', 'title', 'content', 'summary', 'category', 'category_info',
            'content_type', 'tags', 'is_public', 'is_featured', 'is_active',
            'created_by', 'created_by_info', 'updated_by', 'updated_by_info',
            'created_at', 'updated_at', 'view_count', 'helpful_count',
...
class KnowledgeBaseCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KnowledgeBase
        fields = [
            'title', 'content', 'summary', 'category', 'content_type',
            'tags', 'is_public', 'is_featured', 'is_active'
        ]
...
class FAQSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FAQ
        fields = [
            'id', 'question', 'answer', 'category', 'category_info',
