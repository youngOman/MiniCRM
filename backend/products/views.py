...
from .serializers import (
    ...
    ProductVariantSerializer, InventorySerializer, StockMovementSerializer,
    PriceHistorySerializer, ProductStatsSerializer, CategoryStatsSerializer,
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Product.objects.select_related('category', 'brand', 'supplier').prefetch_related('variants')
    ...
    def inventory(self, request, pk=None):
        ...
        try:
            ...
            return Response({'detail': '庫存資訊不存在'}, status=status.HTTP_404_NOT_FOUND)
    ...
    def add_stock_movement(self, request, pk=None):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                # 如果庫存不存在，建立新的
                if movement_type == 'inbound' or (movement_type == 'adjustment' and quantity > 0):
