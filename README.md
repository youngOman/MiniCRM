...
RAG-based AI 客服，結合 LLaMA 3 及 LINE MESSAGING API，檢索系統內部資訊（如知識庫、客服紀錄、SOP、FAQ），透過 LINE 隨時隨地即時與系統互動，AI 助理將能根據系統資料回答精準且具上下文的業務與客戶問題、查詢客戶資料、訂單狀態、交易記錄、客服工單、銷售業績、當季客戶偏好...等資訊
